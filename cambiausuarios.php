...
<head>
    ...
    <title>Beneficiarios (Funcionales)</title>
    <!-- Styles -->
...
<h1>Beneficiarios (Funcionales)</h1>
...
<table id='tablaUsuarios'>
    ...
    <tbody>
        ...
        <?php
            ...
            $conn = conectar();
            $query = $conn->prepare("SELECT id_beneficiario, curp, nombres, paterno, materno, aparato, validado, comentario FROM beneficiario WHERE id_usuario=$idusuario");
            $query->execute();
            ...
            while($query->fetch()){
                ...
                if($validado == "Si"){
                    ...
                    //Boton de Error
                    echo "<td><button data-tooltip='Comentar un error' disabled><i class='bi bi-x-circle'></i></button></td>";
                    ...
                    echo "<td><a class='botoneditar' href='editarBeneficiario.php?id=$id_benficiario'><i class='bi bi-pencil'></i></a></td>";
