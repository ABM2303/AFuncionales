...
<form id="registroDotaciones" method="post" action="">
    <div id="registroDotacionesInputs">
        ...
        <input type="text" name="letraext" id="letraext" placeholder="Letra Exterior" maxlength="1" min="0">
        </div>
        ...
        <input type="text" name="letraint" id="letraint" placeholder="Letra Interior" maxlength="1" min="0">
        </div>
