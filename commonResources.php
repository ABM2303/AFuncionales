...
<!-- Handle de catálogos geográficos -->
<script src="handleCatalogosGeograficos.js"></script>

<!-- Necesarios para generar el archivo de Excel -->
...
<!-- Archivo de Excel (xlsx) para exportación -->
